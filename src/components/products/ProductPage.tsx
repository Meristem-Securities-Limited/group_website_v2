  ...
  return (
    <section className="bg-white">
      ...
      <div className=" container mx-auto px-4 bg-white text-black flex items-center justify-center">
        <div className="w-full flex flex-col md:flex-row md:gap-16 gap-10 lg:py-20 py-20">
          <div className="min-h-100 h-100 w-140">
            <Image
              width={500}
              height={500}
              src={product.img}
        ...
        <div className="relative z-10 container mx-auto py-20 px-4 flex flex-col items-center justify-center text-center">
          <div className="max-w-2xl">
            ...
            <p className="text-white text-base md:text-lg leading-relaxed mb-8">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit earum amet reprehenderit
              voluptates, ullam ad dignissimos unde obcaecati deleniti suscipit molestias impedit id
              laborum maiores corrupti aspernatur atque optio magni!
            </p>
            {/* Download buttons */}
            {(
            ...
            : <button
                ...
                className="px-9 py-3 bg-white text-primary-green font-medium hover:bg-gray-100 transition">
                Contact Us
              </button>
            }
          </div>
