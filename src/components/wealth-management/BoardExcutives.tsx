...
import { wealthManagementBoardMembers } from "@/app/wealth-management-limited/board-members/[slug]/page";
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <motion.section
          ...
          <motion.div
            ...
            {wealthManagementBoardMembers.map((member, index) => (
              <motion.div
                key={index}
                variants={itemVariantsUp}>
                <Link href={`wealth-management-limited/board-members/${member.slug}`}>
