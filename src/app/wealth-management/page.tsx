    ...
    <div className="min-h-screen bg-white">
      ...
      <WhoWeAreSection
        ...
        descriptions={[
          ...
          `In addition to attaining GIPS compliance status ( a standard set by the CFA Institute for best practice among investment management firms globally) for its asset management division.<br>
