...
export const products = [
  // ========== MERISTEM STOCKBROKERS LIMITED ==========
  {
    ...
    img: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&auto=format",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&auto=format",
    subsidiary: "Meristem Stockbrokers Limited",
  },
  {
    slug: "stock-trading",
  ...
  // ========== MERISTEM REGISTRARS AND PROBATE SERVICES LIMITED ==========
  {
    ...
    subsidiary: "Meristem Registrars and Probate Services Limited",
  },
  {
  ...
  },
  {
    ...
    description:
      "Navigate the complexities of estate administration with compassion and clarity through Meristem’s Probate Services. We guide executors and family members through every step: from locating the will and identifying all assets (bank accounts, properties, investments, vehicles) to obtaining the grant of probate from the probate registry. Our team values assets, settles outstanding debts and taxes, and then distributes the remaining inheritance to beneficiaries according to the will or intestacy rules. We also handle the transfer of stockbroking accounts, real estate titles, and other registered assets into beneficiaries’ names. Throughout this often emotional process, we provide regular updates and clear communication to minimize family stress. With Meristem, you honor your loved one’s final wishes efficiently, legally, and respectfully.",
