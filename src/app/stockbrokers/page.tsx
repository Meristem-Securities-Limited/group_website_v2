    ...
    <div className="min-h-screen bg-white">
      ...
      <WhoWeAreSection
        ...
        descriptions={[
          ...
          `Our unwavering commitment to excellence and enduring client relationships has earned the trust of a diverse clientele, reinforcing our position as a dependable partner in creating and growing sustainable wealth through the capital market. <br>
