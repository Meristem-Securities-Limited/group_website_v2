    ...
    <div className="min-h-screen bg-white">
      ...
      <WhoWeAreSection
        ...
        descriptions={[
          ...
          `Meristem Stockbrokers Limited is registered and regulated by the Securities and Exchange Commission (SEC), Nigeria, and holds a Trading License issued by Nigerian Exchange Limited (NGX)`,
